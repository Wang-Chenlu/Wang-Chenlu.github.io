...
module RbConfig
  RUBY_VERSION.start_with?("3.2.") or
    raise "ruby lib version (3.2.11) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MJIT_CC"] = "D:/a/_temp/msys64/ucrt64/bin/gcc.exe"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " -DFD_SETSIZE=2048 -D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
